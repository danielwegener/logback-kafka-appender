...
This is an example `logback.xml` that uses a common `PatternLayoutEncoder` to encode a log message
as a string.
...
Direct logging over the network is not a trivial thing because it might be much less reliable than
